...
namespace RPG.Controllers
{
    public class EnemyController : CharacterController
    {
        ...
        [SerializeField] private Vector3 _targetDetectOffset;
        [SerializeField] private float _targetFollowDistanceLimit;
        ...
        private void Start()
        {
            ...
            _tree.StartBuild()
                .Selector()
                    .Sequence()
                        .CanSeeObject(_targetDetectRadius, _targetDetectAngle, _targetMask, _targetDetectOffset)
